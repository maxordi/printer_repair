...
class MasterRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'specialty.required' => 'Поле Специальность является обязательным для заполнения',
            'experience.required' => 'Поле Стаж работы является обязательным для заполнения',
            'experience.integer' => 'Поле Стаж работы должно быть целым числом',
            'experience.min' => 'Поле Стаж работы не может быть отрицательным',
            'experience.max' => 'Поле Стаж работы не может превышать 50 лет',
